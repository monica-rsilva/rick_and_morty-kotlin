                ...
                Card(modifier = Modifier
                    ...
                    Row(modifier = Modifier
                        ...
                        Column() {
                            ...
                            Text(text = it.species, fontSize = 18.sp, color = Color.White, fontWeight = FontWeight.Bold)
                            Text(text = it.location.name, fontSize = 12.sp, color = Color.Yellow, fontWeight = FontWeight.Bold)
                        }
                    }
                }
            }
